...
write_start_scripts_for(Type, Release, OutputDir, State) ->
    ...
    IncludeStartScriptsFor = rlx_state:include_start_scripts_for(State),
    [write_start_script(BaseName, Type, StartFile)
     || BaseName <- [VsnRel, BareRel]],

    case IncludeStartScriptsFor =/= undefined andalso
        lists:member(powershell, IncludeStartScriptsFor) of
        true ->
